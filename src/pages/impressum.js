  ...
  <div>
    <ResponsiveContainer>
      ...
      <ImpressumContent>
        ...
        <p>
          Haftungsausschluss 1. Inhalt des Onlineangebotes von SoftBricks Stefan
          Sporrer SoftBricks Stefan Sporrer übernimmt keinerlei Gewähr für die
          ...
          Stefan Sporrer, welche sich auf Schäden materieller oder ideeller Art
          ...
          sofern seitens SoftBricks Stefan Sporrer kein nachweislich vorsätzliches
          oder grob fahrlässiges Verschulden vorliegt. Alle Angebote sind
          freibleibend und unverbindlich. SoftBricks Stefan Sporrer behält es sich
          ausdrücklich vor, Teile der Seiten oder das gesamte Angebot ohne
          gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die
          Veröffentlichung zeitweise oder endgültig einzustellen.
        </p>
        <p>
          2. Verweise und Links Bei direkten oder indirekten Verweisen auf fremde
          Internetseiten (”Links”), die außerhalb des Verantwortungsbereiches des
          Autors liegen, würde eine Haftungsverpflichtung ausschließlich in dem
          Fall in Kraft treten, in dem SoftBricks Stefan Sporrer von den Inhalten
          Kenntnis hat und es ihm technisch möglich und zumutbar wäre, die Nutzung
          im Falle rechtswidriger Inhalte zu verhindern. SoftBricks Stefan Sporrer
          ...
          Urheberschaft der gelinkten/verknüpften Seiten hat SoftBricks Stefan
          Sporrer keinerlei Einfluss. Deshalb distanziert er sich hiermit
          ...
          sowie für Fremdeinträge in von SoftBricks Stefan Sporrer eingerichteten
        ...
        <p>
          3. Urheber- und Kennzeichenrecht SoftBricks Stefan Sporrer ist bestrebt,
          in allen Publikationen die Urheberrechte der verwendeten Grafiken,
          ...
          für veröffentlichte, von SoftBricks Stefan Sporrer selbst erstellte
          Objekte bleibt allein bei SoftBricks Stefan Sporrer. Eine
          ...
          Publikationen ist ohne ausdrückliche Zustimmung von SoftBricks Stefan
          Sporrer nicht gestattet.
        </p>
        <p>
